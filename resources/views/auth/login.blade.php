                        ...
                        <form method="POST" action="{{ route('login') }}" class="pt-3">
                            ...
                            <div class="form-group">
                                <input id="user_code" type="text"
                                    class="form-control form-control-lg @error('user_code') is-invalid @enderror"
                                    name="email" value="{{ old('user_code') }}" required autocomplete="user_code"
                                    autofocus placeholder="Username">


                            </div>
                            <div class="form-group position-relative mt-3">
                                <i class="fa fa-eye show_hide_pass" aria-hidden="true"
                                    style="position:absolute; right:10px; top:16px; font-size: 19px; z-index:1000"></i>
                                <input type="password"
                            ...
                            <div class="my-2 d-flex justify-content-center align-items-center">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link"class="auth-link text-black"
